...
public class KafkaConsumerClassWithGracefulShutdown {
	
	private static final Logger log = LoggerFactory.getLogger(KafkaConsumerClassWithGracefulShutdown.class.getSimpleName());
