...
export const STROKE_PATHS: Record<string, CharacterStrokes> = {
  ...
  // ────────────── LOWERCASE a–z ──────────────
  // Lowercase body sits at x-height (y: 0.35–0.95).
  // Ascenders (b, d, f, h, k, l, t) reach up to y: 0.05.
  // Descenders (g, j, p, q, y) drop below baseline to y: 1.0.

  // a — circle + right stem
  'a': [
    [{ x: 0.7, y: 0.4 }, { x: 0.55, y: 0.35 }, { x: 0.35, y: 0.38 }, { x: 0.22, y: 0.5 },
     { x: 0.2, y: 0.65 }, { x: 0.25, y: 0.82 }, { x: 0.4, y: 0.92 }, { x: 0.58, y: 0.9 }, { x: 0.7, y: 0.8 }],
    [{ x: 0.7, y: 0.38 }, { x: 0.7, y: 0.92 }],
  ],
  // b — tall stem + right bump
  'b': [
    [{ x: 0.25, y: 0.05 }, { x: 0.25, y: 0.92 }],
    [{ x: 0.25, y: 0.4 }, { x: 0.45, y: 0.35 }, { x: 0.65, y: 0.4 }, { x: 0.78, y: 0.55 },
     { x: 0.78, y: 0.72 }, { x: 0.65, y: 0.88 }, { x: 0.45, y: 0.92 }, { x: 0.25, y: 0.85 }],
  ],
  // c — small open curve
  'c': [
    [{ x: 0.75, y: 0.42 }, { x: 0.55, y: 0.35 }, { x: 0.35, y: 0.4 }, { x: 0.22, y: 0.55 },
     { x: 0.22, y: 0.72 }, { x: 0.35, y: 0.88 }, { x: 0.55, y: 0.92 }, { x: 0.75, y: 0.85 }],
  ],
  // d — left circle + tall right stem
  'd': [
    [{ x: 0.7, y: 0.8 }, { x: 0.55, y: 0.9 }, { x: 0.38, y: 0.9 }, { x: 0.22, y: 0.78 },
     { x: 0.2, y: 0.62 }, { x: 0.25, y: 0.45 }, { x: 0.4, y: 0.36 }, { x: 0.58, y: 0.38 }, { x: 0.7, y: 0.48 }],
    [{ x: 0.7, y: 0.05 }, { x: 0.7, y: 0.92 }],
  ],
  // e — small loop with horizontal opening
  'e': [
    [{ x: 0.22, y: 0.62 }, { x: 0.78, y: 0.62 }, { x: 0.78, y: 0.48 }, { x: 0.65, y: 0.37 },
     { x: 0.45, y: 0.35 }, { x: 0.28, y: 0.42 }, { x: 0.2, y: 0.58 }, { x: 0.22, y: 0.75 },
     { x: 0.35, y: 0.9 }, { x: 0.55, y: 0.93 }, { x: 0.75, y: 0.85 }],
  ],
  // f — curved top + tall stem + crossbar
  'f': [
  ...
  'h': [
    [{ x: 0.25, y: 0.05 }, { x: 0.25, y: 0.92 }],
    [{ x: 0.25, y: 0.48 }, { x: 0.4, y: 0.37 }, { x: 0.58, y: 0.35 }, { x: 0.72, y: 0.42 },
     { x: 0.75, y: 0.55 }, { x: 0.75, y: 0.92 }],
  ],
  // i — dot + short stem
  'i': [
  ...
  'm': [
    [{ x: 0.12, y: 0.38 }, { x: 0.12, y: 0.92 }],
    [{ x: 0.12, y: 0.5 }, { x: 0.22, y: 0.38 }, { x: 0.38, y: 0.35 }, { x: 0.48, y: 0.42 }, { x: 0.5, y: 0.55 }, { x: 0.5, y: 0.92 }],
    [{ x: 0.5, y: 0.5 }, { x: 0.6, y: 0.38 }, { x: 0.75, y: 0.35 }, { x: 0.85, y: 0.42 }, { x: 0.88, y: 0.55 }, { x: 0.88, y: 0.92 }],
  ],
  // n — short stem + one arch
  'n': [
    [{ x: 0.25, y: 0.38 }, { x: 0.25, y: 0.92 }],
    [{ x: 0.25, y: 0.5 }, { x: 0.4, y: 0.38 }, { x: 0.58, y: 0.35 }, { x: 0.72, y: 0.42 },
     { x: 0.75, y: 0.55 }, { x: 0.75, y: 0.92 }],
  ],
  // o — small oval
  'o': [
    [{ x: 0.5, y: 0.35 }, { x: 0.7, y: 0.4 }, { x: 0.8, y: 0.55 }, { x: 0.8, y: 0.72 },
  ...
  'r': [
    [{ x: 0.3, y: 0.38 }, { x: 0.3, y: 0.92 }],
    [{ x: 0.3, y: 0.55 }, { x: 0.4, y: 0.42 }, { x: 0.55, y: 0.36 }, { x: 0.7, y: 0.38 }],
  ],
  // s — small s-curve
  's': [
    [{ x: 0.7, y: 0.42 }, { x: 0.55, y: 0.35 }, { x: 0.38, y: 0.38 }, { x: 0.28, y: 0.48 },
     { x: 0.35, y: 0.6 }, { x: 0.5, y: 0.65 }, { x: 0.65, y: 0.7 }, { x: 0.72, y: 0.8 },
     { x: 0.62, y: 0.9 }, { x: 0.45, y: 0.93 }, { x: 0.28, y: 0.88 }],
  ],
  // t — tall stem with crossbar
  't': [
    [{ x: 0.45, y: 0.1 }, { x: 0.45, y: 0.82 }, { x: 0.55, y: 0.92 }, { x: 0.68, y: 0.9 }],
    [{ x: 0.25, y: 0.4 }, { x: 0.65, y: 0.4 }],
  ],
  // u — down curve up + short stem
  'u': [
    [{ x: 0.25, y: 0.38 }, { x: 0.25, y: 0.72 }, { x: 0.35, y: 0.88 }, { x: 0.5, y: 0.92 },
     { x: 0.65, y: 0.88 }, { x: 0.75, y: 0.72 }],
    [{ x: 0.75, y: 0.38 }, { x: 0.75, y: 0.92 }],
  ],
  // v — two diagonals meeting at bottom
  'v': [
    [{ x: 0.2, y: 0.38 }, { x: 0.5, y: 0.92 }],
    [{ x: 0.5, y: 0.92 }, { x: 0.8, y: 0.38 }],
  ],
  // w — double-v
  'w': [
    [{ x: 0.08, y: 0.38 }, { x: 0.25, y: 0.92 }],
    [{ x: 0.25, y: 0.92 }, { x: 0.5, y: 0.55 }],
    [{ x: 0.5, y: 0.55 }, { x: 0.75, y: 0.92 }],
    [{ x: 0.75, y: 0.92 }, { x: 0.92, y: 0.38 }],
  ],
  ...
  'z': [
    ...
    [{ x: 0.8, y: 0.38 }, { x: 0.2, y: 0.92 }],
    [{ x: 0.2, y: 0.92 }, { x: 0.8, y: 0.92 }],
  ],
};

/**
 * Return the stroke definitions for a character, or null if unknown.
 * Checks the exact character first (for lowercase), then falls back to uppercase.
 */
export function getStrokes(char: string): CharacterStrokes | null {
  return STROKE_PATHS[char] ?? STROKE_PATHS[char.toUpperCase()] ?? null;
}
